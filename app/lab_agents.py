...
def director_instruction(lab: LabSpec) -> str:
    ...
    return (
        ...
        "challenge and extend each other. Search live sources. Label every conclusion "
        "[Observed here], [Sourced], or [Proposed]. A toy probe never validates a real benchmark. "
        "Return one Handoff: Claim; Evidence "
