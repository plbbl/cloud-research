...
On camera: the empty research brief.

> Research stops every time the researcher steps away—not because the idea is exhausted, but
...
> This is not an AI replacing a scientist. It is a research continuity system. You set the program.
